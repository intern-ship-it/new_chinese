// js/pages/entries/debit-note/create.js
(function($, window) {
    'use strict';
    
    window.EntriesDebitNoteCreatePage = {
        ledgers: [],
        funds: [],
        entryItems: [],
        itemCounter: 0,
        ...
        init: function() {
            ...
            // Note: addDefaultRows() is called after master data loads
        },
            ...
            const html = `
                <div class="container-fluid">
                    <div class="row mb-4">
                        <div class="col">
                            <h3 class="page-title">
                                <i class="bi bi-file-plus"></i> Create Debit Note
                            </h3>
                        </div>
                        <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="narration" rows="2" 
                                                  placeholder="Enter reason for issuing debit note (e.g., Purchase return, Overcharge correction, etc.)"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        loadMasterData: function() {
            const self = this;
            let loadCount = 0;
            const totalLoads = 2; // Loading funds and ledgers
            ...
            // Load Credit Ledgers (excludes inventory ledgers)
            TempleAPI.get('/accounts/entries/ledgers/credit')
                ...
                .fail(function(xhr) {
                    ...
                    TempleAPI.get('/accounts/ledgers')
                        .done(function(response) {
                            if (response.success) {
                                // Filter out inventory ledgers on the frontend as a fallback
        ...
        getLedgerOptions: function() {
            // Generate ledger options with proper formatting
        ...
        saveEntry: function(saveAndNew) {
            ...
            TempleAPI.post('/accounts/entries/debit-note', formData)
                .done(function(response) {
                    if (response.success) {
                        TempleCore.showToast('Debit Note created successfully', 'success');
