// js/pages/entries/journal/edit.js
(function($, window) {
    'use strict';
    
    window.EntriesJournalEditPage = {
        ledgers: [],
        funds: [],
        journalItems: [],
        itemCounter: 0,
            ...
            const html = `
                <div class="container-fluid">
                    <div class="row mb-4">
                        <div class="col">
                            <h3 class="page-title">
                                <i class="bi bi-journal-text"></i> Edit Journal Entry
                            </h3>
                        </div>
                        <div class="col-auto">
        ...
        addJournalRow: function(existingItem = null) {
        ...
        saveJournal: function(saveAndNew) {
            ...
            TempleAPI.put(`/accounts/entries/update/${this.entryId}`, formData)
                .done(function(response) {
                    if (response.success) {
                        TempleCore.showToast('Journal entry modified successfully', 'success');
