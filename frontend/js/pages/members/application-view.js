...
(function($, window) {
    ...
    window.MembersApplicationViewPage = {
      ...
      displayApplicationData: function () {
        ...
        if (app.permanent_member_id) {
          $("#headerPermanentId")
            .show()
            .find("span")
            .text(app.permanent_member_id);
        }

        const statusConfig = this.getStatusConfig(app.status);
        $("#headerStatus").html(
          `<span class="status-badge-large badge ${statusConfig.class}">${statusConfig.label}</span>`
        );
        $("#headerDate").text(
          "Submitted: " +
            this.formatDateTime(app.submitted_at || app.created_at)
        );
        ...
        const html = `
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">${app.mobile_code || ""} ${
          app.mobile_no || "-"
        }</div>
                    </div>
                    <div class="info-item">
      ...
      displayReferralInfo: function (app) {
        ...
        if (app.referrals && app.referrals.length > 0) {
          ...
          app.referrals.forEach((referral, index) => {
            html += this.getReferralBoxHTML(referral, index + 1);
          });
        } else {
          ...
          if (app.referral_1_name) {
            ...
            html += this.getReferralBoxHTML(ref1, 1);
          }
          ...
          if (app.referral_2_name) {
            ...
            html += this.getReferralBoxHTML(ref2, 2);
          }
        }
      ...
      getReferralBoxHTML: function (referral, num) {
        ...
        return `
        <div class="referral-box ${boxClass} mb-3">
            <div class="text-center mb-3">
                ${statusIcon}
                <h6 class="mt-2">Referral ${num} / 推荐人 ${num}</h6>
                <span class="badge ${
            ...
            <div class="info-item">
                <div class="info-label">Member ID / IC / 会员编号</div>
            ...
            ${
              verified
                ? `
                <div class="info-item">
                    <div class="info-label">Verified On / 验证时间</div>
                    <div class="info-value">${this.formatDateTime(
                      verifiedAt
                    )}</div>
                </div>
            `
                    ...
                    ${
                      app.refund_processed
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">${this.formatDate(
                              app.refund_date
                            )}</div>
                        </div>
                        <div class="info-item">
        ...
        return `
                <div class="timeline-event">
                    ...
                    <div class="timeline-event-content">
                        ...
                        ${
                          detail
                            ? `<div class="mt-1"><small>${detail}</small></div>`
                            : ""
                        }
                    </div>
                </div>
