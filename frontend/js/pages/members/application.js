...
(function ($, window) {
  ...
  window.MembersApplicationPage = {
                ...
                <div class="members-application-page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="filter-section card border-0 shadow-sm" data-aos="fade-right"style="translate: none;rotate: none;scale: none;opacity: 1;transform: translate(-76.9366px, 0px);margin-left: 2rem;width: 350px;">
                                <div class="card-body">
                                    <h5 class="mb-4">
    ...
    getApplicationCardHTML: function (app, index) {
      ...
      return `
                <div class="col-md-6 col-lg-4 mb-3" data-aos="fade-up" data-aos-delay="${
                  index * 50
                }">
                    <div class="application-card card h-100" data-id="${
                      app.id
                    }">
                        <div class="card-body">
                            <!-- Header -->
        ...
        app.name
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-1 small">
                                    <i class="bi bi-calendar text-muted"></i> ${this.formatDate(
                                      app.created_at
                                    )}
                                </p>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-outline-primary flex-grow-1" onclick="event.stopPropagation(); MembersApplicationPage.viewApplication('${
                                  app.id
                                }')">
      ...
      this.applications.forEach(function (app) {
        ...
        html += `
                    <tr class="application-row" data-id="${app.id}">
                        ...
                        <td>${app.email}</td>
                        <td>${app.mobile_no}</td>
                        <td><span class="status-badge ${statusConfig.class}">${
          statusConfig.label
        }</span></td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button class="btn btn-outline-primary" onclick="MembersApplicationPage.viewApplication('${
                                  app.id
                                }')">
                                    <i class="bi bi-eye"></i>
                                </button>
    ...
    verifyApplication: function (applicationId) {
      TempleRouter.navigate("members/application-verify", {
        id: applicationId,
      });
    },
