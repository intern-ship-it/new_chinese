...
(function ($, window) {
  ...
  window.MembersApplicationFormPage = {
    ...
    getReferralCardHTML: function (referral, index) {
      ...
      return `
            <div class="referral-card mb-3 p-3 border rounded ${
              referral.validated ? "validated" : ""
            }" data-referral-id="${referral.id}">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <h5 class="mb-0">
                        <i class="bi bi-person-check"></i> Referral ${
                          index + 1
                        } / 推荐人 ${index + 1}
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Full Name / 全名 ${
                          index < 2 ? '<span class="text-danger">*</span>' : ""
                        }</label>
                        <input type="text" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="validation-msg mt-2" data-referral-id="${
                          referral.id
                        }"></div>
                    </div>
                </div>
...
<style>
    ...
    getProgressStepsHTML: function () {
      ...
      steps.forEach((step, index) => {
        ...
        html += `
            <div class="col progress-step ${isActive ? "active" : ""} ${
          isCompleted ? "completed" : ""
        }">
                <div class="step-icon">
                    <i class="bi ${
                      isCompleted ? "bi-check-lg" : step.icon
                    }"></i>
                </div>
                <div class="step-title">${step.title}<br><small>${
          step.titleCN
        }</small></div>
            </div>
        `;
