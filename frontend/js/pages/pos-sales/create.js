...
(function ($, window) {
    ...
    window.PosSalesCreatePage = {
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">NAME (PRIMARY)</label>
                                <input type="text" class="form-control" id="devoteeNamePrimary" placeholder="Enter primary name" value="${this.devoteeDetails.name_primary}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">NAME (SECONDARY)</label>
                                <input type="text" class="form-control" id="devoteeNameSecondary" placeholder="Enter secondary name" value="${this.devoteeDetails.name_secondary}">
                            </div>
                            <div class="col-md-6">
        ...
        openDevoteeModal: function () {
            ...
            $('#devoteeNamePrimary').val(this.devoteeDetails.name_primary);
            $('#devoteeNameSecondary').val(this.devoteeDetails.name_secondary);
        ...
        saveDevoteeDetails: function () {
            this.devoteeDetails = {
                name_primary: $('#devoteeNamePrimary').val().trim(),
                name_secondary: $('#devoteeNameSecondary').val().trim(),
...
hasDevoteeData: function() {
    return this.devoteeDetails.name_primary || this.devoteeDetails.name_secondary || 
           this.devoteeDetails.email || this.devoteeDetails.nric || 
           this.devoteeDetails.phone || this.devoteeDetails.dob || 
           this.devoteeDetails.address || this.devoteeDetails.remarks;
},
        ...
        proceedBooking: function () {
            ...
            // Prepare order data - send only minimal data, backend will calculate amounts and fetch item details
            const orderData = {
                ...
                // Only send id, deity_id, quantity, and vehicles for each item
