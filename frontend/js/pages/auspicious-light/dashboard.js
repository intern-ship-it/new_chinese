...
(function ($, window) {
    ...
    window.PagodaDashboardPage = {
        ...
        // Render page structure - REMOVED ALL AOS
        render: function () {
            const html = `
                <div class="pagoda-dashboard-container">
                    ...
                    <div class="quick-actions">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                <div class="col-6 col-md-3">
                                <button class="btn btn-outline-primary w-100 py-3 quick-action-btn" data-route="pagoda/lights">
                                    <i class="bi bi-lightbulb d-block mb-2" style="font-size: 24px;"></i>
                                    View Lights
                                </button>
                            </div>
                            <div class="col-6 col-md-3">
                                <button class="btn btn-outline-info w-100 py-3 quick-action-btn" data-route="pagoda/registrations">
                                    <i class="bi bi-list-check d-block mb-2" style="font-size: 24px;"></i>
                                    Registrations
                                </button>
                            </div>
                            <div class="col-6 col-md-3">
                                <button class="btn btn-outline-success w-100 py-3 quick-action-btn" data-route="pagoda/devotees">
                                    <i class="bi bi-people d-block mb-2" style="font-size: 24px;"></i>
                                    Devotees
                                </button>
                            </div>
                            <div class="col-6 col-md-3">
                                <button class="btn btn-outline-warning w-100 py-3 quick-action-btn" data-route="auspicious-light/index">
                                    <i class="bi bi-graph-up d-block mb-2" style="font-size: 24px;"></i>
                                    Reports
                                </button>
                            </div>
        ...
        // Render overview cards - REMOVED AOS
        renderOverviewCards: function (overview) {
            const html = `
                <div class="row g-4 mb-4">
                    <!-- Total Lights -->
        ...
        // Render expiring alerts - REMOVED AOS
        renderExpiringAlerts: function (activeRegs) {
            const html = `
        ...
        // Render recent activity - REMOVED AOS
        renderRecentActivity: function (recentRegs) {
            if (!recentRegs || recentRegs.length === 0) {
                $('#recent-activity').html(`
            ...
            const html = `
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-sm btn-outline-primary" id="btnViewAllRegistrations" data-route="pagoda/registrations">
                            <i class="bi bi-list-ul"></i> View All
                        </a>
                    </div>
                    <div class="card-body p-0">
        ...
        detachEvents: function () {
            ...
            $(document).off('.pagodaDashboard');

            console.log('Pagoda Dashboard events detached');
        },

        // Attach event handlers with proper navigation
        attachEvents: function () {
            const self = this;
            ...
            // Refresh button
            $(document).on('click.pagodaDashboard', '#btnRefreshDashboard', function () {
                self.loadDashboardData();
            });

            // New registration button
            $(document).on('click.pagodaDashboard', '#btnNewRegistration', function () {
                TempleRouter.navigate('auspicious-light/entry');
            });

            // Quick Action buttons - Navigate to proper routes
            $(document).on('click.pagodaDashboard', '.quick-action-btn', function (e) {
                e.preventDefault();
                const route = $(this).data('route');
                if (route) {
                    console.log('Navigating to:', route);
                    TempleRouter.navigate(route);
                }
            });

            // View All Registrations button
            $(document).on('click.pagodaDashboard', '#btnViewAllRegistrations', function (e) {
                e.preventDefault();
                const route = $(this).data('route');
                if (route) {
                    console.log('Navigating to:', route);
        ...
        // Cleanup
        destroy: function () {
            console.log('Cleaning up Pagoda Dashboard page');
            ...
            console.log('Pagoda Dashboard page cleaned up');
        }
    };
